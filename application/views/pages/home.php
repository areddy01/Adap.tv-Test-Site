...
// $myString = ""; if($slide['logogallery'] == 1){$myString = "True"; } else{$myString = "False"; }
           			echo '<div class="ls-layer"  style="slidedirection: right; data-time="'.$slide['displaytime'].'">
							<img src="'.$slide['bgimage'].'" border="0" class="ls-bg" alt="Slide background" />
							';
           			echo '
							<img src="'.$slide['layer1image'].'" border="0" class="ls-s-1 text" style=" top:0px; left: 0px; slidedirection : fade; slideoutdirection : fade; durationin : 750; durationout : 750; easingin : easeOutQuint; fadein : 90; "/>
							';
           			echo '
							<a class="ls-s2" href="'.$slide['ctalink'].'" target="'.$slide['ctatarget'].'" style=" top:335px; left: 65px; slidedirection : fade; slideoutdirection : fade; durationin : 750; durationout : 750; easingin : easeOutQuint; fadein : 90; ">
								';
           			echo '
								<img src="'.$slide['layer2image'].'" border="0"  />
								';
           			//echo $myString;
           			echo '
							</a>
	...
	?>
						<div id="leftModule">
							<div class="homeModuleHeader">
								<a href="http://adap.tv/news">
									<?php echo $leftspot['title']; ?></a>
							</div>
							<div class="homeModuleImage">
								<img src="<?php echo $leftspot['bgimage']; ?>" width="275" height="150"></div>
							<div class="homeModuleParagraph">
								<?php echo $leftspot['bio']; ?></div>
							<div class="homeModuleCTA">
								<a href="<?php echo $leftspot['ctalink']; ?>
									" target="
									<?php echo $leftspot['ctatarget']; ?>
									">
									<img src="/styles/images/learn-more.png" alt="Learn More" width="105" height="25" border="0"></a>
							</div>
						...
						<div id="middleModule">
							<div class="homeModuleHeader">
								<a href="http://adap.tv/news">
									<?php echo $midspot['title']; ?></a>
							</div>
							<div class="homeModuleImage">
								<img src="<?php echo $midspot['bgimage']; ?>" width="275" height="150"></div>
							<div class="homeModuleParagraph">
								<?php echo $midspot['bio']; ?></div>
							<div class="homeModuleCTA">
								<a href="<?php echo $midspot['ctalink']; ?>
									" target="
									<?php echo $leftspot['ctatarget']; ?>
									">
									<img src="/styles/images/learn-more.png" alt="Learn More" width="105" height="25" border="0"></a>
						...
						<div id="rightModule">
							<div class="homeModuleHeader">
								<a href="http://adap.tv/news">
									<?php echo $rightspot['title']; ?></a>
							</div>
							<div class="homeModuleImage">
								<img src="<?php echo $rightspot['bgimage']; ?>" width="275" height="150"></div>
							<div class="homeModuleParagraph">
								<?php echo $rightspot['bio']; ?></div>
							<div class="homeModuleCTA">
								<a href="<?php echo $rightspot['ctalink']; ?>
									" target="
									<?php echo $rightspot['ctatarget']; ?>
									">
									<img src="/styles/images/learn-more.png" alt="Learn More" width="105" height="25" border="0"></a>
							</div>
						</div>
						...
						<div class="clear"></div>
						<a id="leftBoxButton" class="arrowButton<?=(($types[0] == "articleplaceholder") ? ' news' : '')?>
							" target="
							<?=$targets[0]?>
							" href="
							<?=$links[0]?>
							">
							<?=$ctas[0]?></a>
						<a id="centerBoxButton" class="arrowButton<?=(($types[1] == "articleplaceholder") ? ' news' : '')?>
							" target="
							<?=$targets[1]?>
							" href="
							<?=$links[1]?>
							">
							<?=$ctas[1]?></a>
						<a id="rightBoxButton" class="arrowButton<?=(($types[2] == "articleplaceholder") ? ' news' : '')?>
							" target="
							<?=$targets[2]?>
							" href="
							<?=$links[2]?>
